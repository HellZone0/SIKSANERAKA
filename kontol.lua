...
local function setFpsCap(n)
    if typeof(setfpscap) == "function" then setfpscap(n) 
    elseif typeof(setsynmaxfps) == "function" then setsynmaxfps(n) end
end
SettingsMisc:Dropdown({
    Title = "FPS Cap",
    Values = {"60","90","120","Max"},
...
-----------------------------------------------------
-- (lanjutan: Config Save/Load kamu tetap di bawah sini)
-----------------------------------------------------
