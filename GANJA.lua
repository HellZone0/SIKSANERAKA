...
-- =========================
-- 🔹 Anti AFK Module Inline
-- =========================
local AntiAFK = {}
AntiAFK.Enabled = false
AntiAFK.Interval = 60 -- detik, setiap berapa lama melakukan aksi
AntiAFK._connection = nil

-- Fungsi untuk aksi anti-AFK
...
function AntiAFK:Start()
    ...
    -- backup loop kalau Idled event tidak jalan
    task.spawn(function()
...
local UI = ensureWindUI(); if not UI then warn("[HELLZONEv1] WindUI gagal dimuat."); return end
local Window = UI:CreateWindow({
Title = "HELLZONE - Fish It",
Icon = "circle-check",
Author = "developed by @minsoo",
...
User = { Enabled = true, Anonymous = false, Callback = function() end }
    ...
    Window:EditOpenButton({ Title = "HELLZONE v1", Icon = "circle-check", CornerRadius = UDim.new(0,16), StrokeThickness = 2, Color = ColorSequence.new(Color3.fromHex("9600FF"), Color3.fromHex("AEBAF8")), Draggable = true })
Window:Tag({ Title = "V1 - STABLE", Color = Color3.fromHex("#ffcc00") })
UI:SetNotificationLower(true)
pcall(function() UI:Notify({ Title = "HELLZONE - Fish It v1", Content = "Script loaded successfully", Duration = 4, Icon = "circle-check" }) end)
...
eventState.platform.Name = "HELLZONEv1EventPlatform"
...
-- Anti Afk
local MiscTab = Window:CreateTab("Settings & Misc")
...
return "HELLZONEv1_Config_" .. tostring(player.UserId or player.Name or "User")
end
...
if not ok then 
warn("[HELLZONEv1] Error: " .. tostring(err))
pcall(function() 
game.StarterGui:SetCore("SendNotification", { 
Title = "HELLZONE v1 Error", 
